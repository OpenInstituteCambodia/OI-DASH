...
package org.odk.collect.android.cfc.activities;
...
import org.odk.collect.android.cfc.exception.JavaRosaException;
import org.odk.collect.android.cfc.listeners.AdvanceToNextListener;
import org.odk.collect.android.cfc.listeners.FormLoaderListener;
import org.odk.collect.android.cfc.listeners.FormSavedListener;
import org.odk.collect.android.cfc.listeners.SavePointListener;
import org.odk.collect.android.cfc.logic.FormController;
import org.odk.collect.android.cfc.logic.FormController.FailedConstraint;
import org.odk.collect.android.cfc.logic.PropertyManager;
import org.odk.collect.android.cfc.preferences.AdminPreferencesActivity;
import org.odk.collect.android.cfc.preferences.PreferencesActivity;
import org.odk.collect.android.cfc.provider.FormsProviderAPI.FormsColumns;
import org.odk.collect.android.cfc.provider.InstanceProviderAPI;
import org.odk.collect.android.cfc.provider.InstanceProviderAPI.InstanceColumns;
import org.odk.collect.android.cfc.tasks.FormLoaderTask;
import org.odk.collect.android.cfc.tasks.SavePointTask;
import org.odk.collect.android.cfc.tasks.SaveResult;
import org.odk.collect.android.cfc.tasks.SaveToDiskTask;
import org.odk.collect.android.cfc.utilities.CompatibilityUtils;
import org.odk.collect.android.cfc.utilities.FileUtils;
import org.odk.collect.android.cfc.utilities.GazetterUtil;
import org.odk.collect.android.cfc.utilities.MediaUtils;
import org.odk.collect.android.cfc.utilities.PropertiesUtils;
import org.odk.collect.android.cfc.views.ODKView;
import org.odk.collect.android.cfc.widgets.QuestionWidget;
...
public class FormEntryActivity extends Activity implements AnimationListener,
    ...
    private static FormEntryActivity instance = null;
    ...
    public FormEntryActivity() {
        // Exists only to defeat instantiation.
    }

    public static FormEntryActivity
    getInstance() {
        if (instance == null) {
            instance = new FormEntryActivity();
        }
        return instance;
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        editor = getSharedPreferences("NEW_ISSUE_FORM", MODE_PRIVATE).edit();
        ...
        //Reset Gazetteer Utils
        GazetterUtil.set_provinceId("");
        GazetterUtil.set_districtId("");
        GazetterUtil.set_communeId("");
        GazetterUtil.set_villageId("");
    ...
    protected void onActivityResult(int requestCode, int resultCode,
        ...
        switch (requestCode) {
            ...
            case LOCATION_CAPTURE:
                ...
                PropertiesUtils.setLocationGPS(sl);
...
*/
    ...
    private View createView(int event, boolean advancingPage) {
        ...
        switch (event) {
            ...
            case FormEntryController.EVENT_END_OF_FORM:
                ...
                // Create 'save' button
                btnSave = (Button) endView.findViewById(R.id.save_exit_button);
                ...
                btnSave.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (saveAs.getText().length() < 1) {
                            ...
                            //set newForm boolean to false to make sure button save_exit_continue not clicked
                            editor.clear();
                            editor.putBoolean("new_issue", false);
                            editor.commit();

                        }
                    }
                });
                //Button btnSave_New = (Button) endView.findViewById(R.id.save_new_button);
                //endView.findViewById(R.id.save_new_button).setOnClickListener(new OnClickListener() {

                 /* Add by Borey 06-oct-15
                    Next new fill form
                 */
                /*btnSave_New.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View v) {

                        btnSave.performClick();
                        //if(saveDataToDisk(EXIT, instanceComplete.isChecked(),saveAs.getText().toString())){
                        // Collect.getInstance().getApplicationContext().getS

                        new ODKBridge(FormEntryActivity.this).loadFormByID("frm_issue_tracking");
        ...
        try {
            ...
            switch (event) {
                ...
                case FormEntryController.EVENT_GROUP:
                    ...
                    next = createView(event, true);
                    showView(next, AnimationType.FADE);
                    break;
                case FormEntryController.EVENT_END_OF_FORM:
                case FormEntryController.EVENT_REPEAT:
                    next = createView(event, true);
    ...
    private void showPreviousViewFade() {
        try {
            FormController formController = Collect.getInstance()
                    .getFormController();
            // The answer is saved on a back swipe, but question constraints are
    ...
    public void refreshSpinner() {
        try {
//        	showNextViewFade();
//    		showPreviousViewFade();
            Log.i("seng", "refreshSpinner");
            ...
            if (formController.getEvent() != FormEntryController.EVENT_BEGINNING_OF_FORM) {
                int event = FormEntryController.EVENT_REPEAT;
                Log.i("sengelse", "refreshSpinner");
                if (event == FormEntryController.EVENT_BEGINNING_OF_FORM
                        || event == FormEntryController.EVENT_GROUP
                        || event == FormEntryController.EVENT_QUESTION) {
                    // create savepoint
                ...
                View next = createView(event, false);
                showViewSpinner(next);

            } else {
                mBeenSwiped = false;
                Log.i("sengelse", "refreshSpinner else");
            }
        } catch (Exception e) {
            Log.e(t, e.getMessage(), e);
            createErrorDialog(e.getCause().getMessage(), DO_NOT_EXIT);
    ...
    public void showViewSpinner(View next) {
        ...
        switch (saveStatus) {
            ...
            case FormEntryController.ANSWER_REQUIRED_BUT_EMPTY:
                ...
                if (constraintText == null) {
                    ...
                    if (constraintText == null) {
                        String requiredMsg = getString(R.string.required_answer_error);
                        String questionText =formController.getQuestionPrompt(index).getQuestionText();
                        constraintText = requiredMsg + "\n" +  questionText;
                        //formController.getQuestionPrompt(index).getQuestion();
                    }
                }
                break;
            default:
                ...
                .setSingleChoiceItems(languages, selected,
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                dialog.dismiss();
                                Resources res = Collect.getInstance().getResources();
                                // Change locale settings in the app.
                                DisplayMetrics dm = res.getDisplayMetrics();
                                if (languages[whichButton].equalsIgnoreCase("Central Khmer")) {
                                    android.content.res.Configuration conf = res.getConfiguration();
                                    conf.locale = new Locale("km".toLowerCase());
    ...
    public void loadingComplete(FormLoaderTask task) {
        ...
        if (languageTest != null) {
            ...
            String newLanguage = "";
            String mySetLanguage = "";
            SharedPreferences pref = getSharedPreferences("CHANGE_LANG", MODE_PRIVATE);
            if (pref.getString("KHM", "").equalsIgnoreCase("KHM")) {
                setLocale("km");
                //newLanguage = "km";
                mySetLanguage = "Central Khmer";

            } else if (pref.getString("ENG", "").equalsIgnoreCase("ENG")) {
                //setLocale("en");
                //newLanguage = "en";
                mySetLanguage = "default";
            }
    ...
    public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
        ...
        if (doSwipe) {
            ...
            int yPixelLimit = (int) (dm.ydpi * .40);
    ...
    private void sendSavedBroadcast() {
        Intent i = new Intent();
        i.setAction("org.odk.collect.android.cfc.FormSaved");
    ...
    private void setLocale(String myLocale) {
