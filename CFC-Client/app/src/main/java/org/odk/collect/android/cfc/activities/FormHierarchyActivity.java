...
import org.odk.collect.android.cfc.adapters.HierarchyListAdapter;
...
import org.odk.collect.android.cfc.logic.HierarchyElement;
            ...
            while (event != FormEntryController.EVENT_END_OF_FORM) {
                ...
                switch (event) {
                    case FormEntryController.EVENT_QUESTION:
                        ...
                        if (!fp.isReadOnly() || (label != null && label.length() > 0 && !label.startsWith("$"))) {
                    ...
                    case FormEntryController.EVENT_GROUP:
                        ...
                        String groupQuest = formController.getLastGroupText();
                        formList.add(new HierarchyElement(groupQuest,"", null,
                                Color.rgb(31,182,237), GROUP, formController.getFormIndex().getTerminal()));
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        switch (h.getType()) {
            ...
            case QUESTION:
                ...
                return;
            case GROUP:
                Collect.getInstance().getActivityLogger().logInstanceAction(this, "onListItemClick", "GROUP-JUMP", index);
                Collect.getInstance().getFormController().jumpToIndex(index);
                setResult(RESULT_OK);
                finish();
                break;
