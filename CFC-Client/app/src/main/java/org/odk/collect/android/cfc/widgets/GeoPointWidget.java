...
import org.odk.collect.android.cfc.activities.GeoPointActivity;
import org.odk.collect.android.cfc.activities.GeoPointMapActivity;
...
public class GeoPointWidget extends QuestionWidget implements IBinaryWidget {
    ...
    public GeoPointWidget(Context context, FormEntryPrompt prompt) {
        ...
        if (PropertiesUtils.getLocationGPS() != null) {
            mStringAnswer.setText(PropertiesUtils.getLocationGPS());
        }
        ...
        mGetLocationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String s = mStringAnswer.getText().toString();
                //String s = PropertiesUtils.getLocationGPS();
                if (s.length() != 0) {
                    String[] sa = s.split(" ");
                    double gp[] = new double[4];
                    gp[0] = Double.valueOf(sa[0]).doubleValue();
        ...
        addView(mViewButton);
        if (PropertiesUtils.getLocationGPS() != null) {
            setBinaryData(mStringAnswer.getText());
        }
    ...
    public void setBinaryData(Object answer) {
        ...
        if (PropertiesUtils.getLocationGPS() != null) {
            s = PropertiesUtils.getLocationGPS();
        }
