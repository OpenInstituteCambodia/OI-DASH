...
import org.odk.collect.android.cfc.activities.FormEntryActivity;
...
public class SpinnerWidget extends QuestionWidget {
    ...
    public SpinnerWidget(final Context context, final FormEntryPrompt prompt) {
        ...
        if (hcVillageComeField.equalsIgnoreCase("province_")) {
            ...
            choices[_mProvinceList.size()] = getResources().getString(R.string.lblChoose);
            PropertiesUtils.setSp_province(spinner);
            overriceOnItemSelected = true;
        } else if (hcVillageComeField.equalsIgnoreCase("district_")) {
            ...
            if (PropertiesUtils.getSelectedProvince() != null) {
                ...
                for (int i = 0; i < _mDistrictList.size(); i++) {
                    ...
                    //District distrctNeighboring = null;
                    try {
                        selectDistrict = mDistrict.get(_mDistrictList.get(i).getdCode());
                        //distrctNeighboring = mDistrict.get(9999);
                    } catch (ParseException e) {
                        e.printStackTrace();
                    }
                ...
                choices[_mDistrictList.size()] = getResources().getString(R.string.lblChoose);

            } else {
                choices[0] = getResources().getString(R.string.lblChoose);
            }
        } else if (hcVillageComeField.equalsIgnoreCase("Commune_")) {
            ...
            if (PropertiesUtils.getSelectedDistrict() != null) {
                ...
                choices[_mCommuneList.size()] = getResources().getString(R.string.lblChoose);
            } else {
                choices[0] = getResources().getString(R.string.lblChoose);
            }
        } else if (hcVillageComeField.equalsIgnoreCase("Village_")) {
            ...
            if (PropertiesUtils.getSelectedCommune() != null) {
                ...
                choices[_mVillageList.size()] = getResources().getString(R.string.lblChoose);
            } else {
                choices[0] = getResources().getString(R.string.lblChoose);
            }
        } else {
            ...
            choices[mItems.size()] = getResources().getString(R.string.lblChoose);
        }
        ...
        if (overriceOnItemSelected) {
            spinner.setOnItemSelectedListener(new org.odk.collect.android.cfc.listeners.OnItemSelectedListener(context));
        } else {
            spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    if (position == size || choices.length == 1) {
                        ...
                        //Add refresh spinner (main_area, sector, and sub_sector)
                        else {
                            if (hcVillageComeField.equalsIgnoreCase("main_area") || hcVillageComeField.equalsIgnoreCase("sector")) {
                   ...
                   /* Boolean selectedOther = false;
                    if (hcVillageComeField.equalsIgnoreCase("sector")){
                        if(getSpinner().getSelectedItem().equals("Other")){
                            Toast.makeText(getContext(),getSpinner().getSelectedItem().toString(),Toast.LENGTH_SHORT).show();
                           selectedOther = true;
                        }
                    }
                    if (hcVillageComeField.equalsIgnoreCase("sub_sector")){
                        if(selectedOther){
                            Toast.makeText(getContext(),"test",Toast.LENGTH_SHORT).show();
                            getSpinner().setSelection(getSpinner().getCount() -1 );
                        }
