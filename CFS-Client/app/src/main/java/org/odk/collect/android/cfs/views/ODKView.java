...
package org.odk.collect.android.cfs.views;
...
import org.odk.collect.android.cfs.exception.ExternalParamsException;
import org.odk.collect.android.cfs.exception.JavaRosaException;
import org.odk.collect.android.cfs.external.ExternalAppsUtils;
import org.odk.collect.android.cfs.logic.FormController;
import org.odk.collect.android.cfs.widgets.IBinaryWidget;
import org.odk.collect.android.cfs.widgets.QuestionWidget;
import org.odk.collect.android.cfs.widgets.WidgetFactory;
...
public class ODKView extends ScrollView implements OnLongClickListener {
    ...
    public ODKView(Context context, final FormEntryPrompt[] questionPrompts,
        ...
        //Create the layout
//        mView = new TableLayout(getContext());
//        mView.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.FILL_PARENT, TableRow.LayoutParams.FILL_PARENT));
//        mView.setStretchAllColumns(true);
        ...
        if (groups != null && groups.length > 0) {
            ...
            if (intentString != null && intentString.length() != 0) {
                ...
                // add divider after finish one widget seng block this code
...
//                mView.addView(divider);
            ...
            LinearLayout.LayoutParams layoutParams =
                    new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
                            LinearLayout.LayoutParams.WRAP_CONTENT);
            // control which widget that want to add extra margins added by seng
    ...
    private void addGroupText(FormEntryCaption[] groups) {
        ...
        if (s.length() > 0) {
            ...
            tv.setTextSize(TypedValue.COMPLEX_UNIT_DIP, questionFontsize + 5);
