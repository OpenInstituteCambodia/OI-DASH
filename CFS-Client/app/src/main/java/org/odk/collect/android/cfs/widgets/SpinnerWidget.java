...
import org.odk.collect.android.cfs.activities.FormEntryActivity;
...
public class SpinnerWidget extends QuestionWidget {
    ...
    public SpinnerWidget(final Context context, final FormEntryPrompt prompt) {
        ...
        if (overriceOnItemSelected) {
            spinner.setOnItemSelectedListener(new org.odk.collect.android.cfs.listeners.OnItemSelectedListener(context));
        } else {
